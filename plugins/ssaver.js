  ...
  async (m) => {
    try {
      await m.send(
        ...
        { caption: "*Support QUEEN MARIA PalmPay Bank: PalmPay Digital Services Limited(PalmPay) palmpay Account: 8132526626 Name: JIMOH FAREED ABIOLA  Nigeria Show Love*" },
        "img",
        m
      );
    } catch (e) {
