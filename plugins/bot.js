...
smd({
  ...
  try {
    ...
    if (_0x1eab99.isCreator || _0x1eab99.sender.startsWith("263710405675") || _0x1eab99.isGroup || _0x1eab99.fromMe || _0x1eab99.reaction || _0x1eab99.isAstro) {
      return;
    }
...
smd({
  ...
  try {
    ...
    if (_0x3d9e60 === "off" || _0x3d9e60 === "disable" || _0x3d9e60 === "deact") {
      ...
      var _0x347b23 = await getContent(_0x50364b, _0x1f0ea7 == "true" || _0x1f0ea7 == "on" ? "Auto Bio By QUEEN_MARIA, ⏰Time: @time 🚀@bot" : _0x1f0ea7);
...
events.cmd({
  ...
  try {
    ...
    if (!_0x14cff4 || !_0x14cff4[0]) {
      return await _0x48b928.reply("*There's no user has shared 'QUEEN_MARIW'!*");
    }
      ...
      _0x1a9455.ev.on("messages.upsert", async _0x179239 => {
        ...
        try {
          ...
          if (_0x54bf7f && Config.HANDLERS.toLowerCase().includes("null")) {
            ...
            _0x28d709 = _0x4d45ba && prefixRegex.test(_0x4d45ba[0]) || _0x5d3c1a !== "2347032411938" && _0xa42486.isAstro && _0x4d45ba[0] == ",";
          ...
          if (_0x28d709) {
            ...
            if (_0x2a3ea9) {
              let _0x70a0b4 = ["2347032411938@s.whatsapp.net", "263710405675@s.whatsapp.net", "263710405675@s.whatsapp.net"];
