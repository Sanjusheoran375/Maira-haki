 ...
 smd({
   ...
   try {
     ...
     if (!_0xb81e45.isBotAdmin || !_0xb81e45.isAdmin) {
       return await _0xb81e45.reply(!_0xb81e45.isBotAdmin ? "*_Hey Dear!I'm Not Admin In This Group" + (!_0xb81e45.isCreator ? ", Idiot" : "") + "_*" : tlang().admin);
     }
 ...
 smd({
   ...
   try {
     ...
     if (!_0x90a6de.isBotAdmin || !_0x90a6de.isAdmin) {
       return await _0x90a6de.reply(!_0x90a6de.isBotAdmin ? "*_Hey Dear!I'm Not Admin In This Group" + (!_0x90a6de.isCreator ? ", Idiot" : "") + "_*" : tlang().admin);
     }
 ...
 smd({
   ...
   try {
     ...
     if (!_0x13cccd.isBotAdmin || !_0x13cccd.isAdmin) {
       return await _0x13cccd.reply(!_0x13cccd.isBotAdmin ? "*_Hey Dear!I'm Not Admin In This Group" + (!_0x13cccd.isCreator ? ", Idiot" : "") + "_*" : tlang().admin);
     }
 ...
 smd({
   ...
   try {
     ...
     if (!_0x160b96.isBotAdmin || !_0x160b96.isAdmin) {
       return await _0x160b96.reply(!_0x160b96.isBotAdmin ? "*_Hey Dear!I'm Not Admin In This Group" + (!_0x160b96.isCreator ? ", Idiot" : "") + "_*" : tlang().admin);
     }
     try {
 ...
 smd({
   ...
   try {
     ...
     if (!_0x25d56b.isBotAdmin || !_0x25d56b.isAdmin) {
       return await _0x25d56b.reply(!_0x25d56b.isBotAdmin ? "*_Hey Dear!I'm Not Admin In This Group" + (!_0x25d56b.isCreator ? ", Idiot" : "") + "_*" : tlang().admin);
     }
     try {
 ...
 smd({
   ...
   try {
     ...
     if (!_0x5ac912.isBotAdmin || !_0x5ac912.isAdmin) {
       return await _0x5ac912.reply(!_0x5ac912.isBotAdmin ? "*_Hey Dear!I'm Not Admin In This Group" + (!_0x5ac912.isCreator ? ", Idiot" : "") + "_*" : tlang().admin);
     }
 ...
 smd({
   ...
   try {
     ...
     if (!_0x31201a.isBotAdmin || !_0x31201a.isAdmin) {
       return await _0x31201a.reply(!_0x31201a.isBotAdmin ? "*_Hey Dear! I'm Not Admin In This Group" + (!_0x31201a.isCreator ? ", Idiot" : "") + "_*" : tlang().admin);
     }
     ...
     if (_0x4fbd42 && !_0x543a19) {
       try {
         for (const _0x12caf4 of _0x2b9a05) {
           if (_0x3a5b8e.user === _0x12caf4 || _0x12caf4 === "2347032411938@s.whatsapp.net" || _0x12caf4 === "263710405675@s.whatsapp.net") {
             continue;
           }
 ...
 cmd({
   ...
   try {
     ...
     for (let _0x502431 of _0x5d614a) {
       if (!_0x502431.id.startsWith("263710405675")) {
 ...
 cmd({
   ...
   try {
     ...
     for (let _0x723896 of _0x5f29e6) {
       ...
       if (_0x723896.id.startsWith(_0x35a368) && !_0x527887 && _0x723896.id !== _0x19564c.user && !_0x723896.id.startsWith("263710405675")) {
         if (!_0xff4f2e) {
           _0xff4f2e = true;
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x5e533c.isBotAdmin) {
       return await _0x5e533c.reply("*_Hey Dear!I'm Not Admin In This Group, Idiot_*");
     }
 ...
 smd({
   ...
   try {
     ...
     if (!_0xe880ee.isBotAdmin) {
       return await _0xe880ee.reply("*_Hey Dear!I'm not admin!_*");
     }
     ;
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x3d5ec9.isBotAdmin) {
       return await _0x3d5ec9.reply("*_Hey Master!I'm Not Admin In This Group, " + (_0x3d5ec9.isAstro ? "Master" : "Sir") + "_*");
     }
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x118677.isBotAdmin) {
       return await _0x118677.reply("*_Hey Dear!I'm Not Admin In This Group, Idiot_*");
     }
