...
`;
     ...
     try {
       ...
       for (let i = startIndex - 1; i < endIndex; i++) {
         ...
         if (isSticker) {
           ...
           await message.reply(
             sticker,
             { packname: Config.packname, author: "Queen_Maria-Md" },
             "sticker"
           );
         } else {
     ...
     try {
       ...
       if (!_0x1c586e) {
         return await _0x1ae8f8.reply(
           "*Provide Repo Url, _.gitclone https://github.com/hakisolos/Queen_Maria_*"
         );
       }
       const _0x5906ab =
 ...
 smd({
   ...
   try {
     ...
     if (!_0x204f81) {
       return _0x55aba2.reply("*_Example : .tts Hi,I am Queen_Maria whatsapp bot._*");
     }
     try {
       ...
       await _0x55aba2.bot.sendMessage(_0x55aba2.jid, {
         ...
         mimetype: "audio/mpeg",
         ptt: true,
         fileName: "Queen-Maria-Md-tts.m4a"
       }, {
         quoted: _0x55aba2
       });
     }
 ...
 smd(
   ...
   async (m, url) => {
     try {
       ...
       const caption = `『 *Qᴜᴇᴇɴ_Mᴀʀɪᴀ Mᴇᴅɪᴀғɪʀᴇ Dᴏᴡɴʟᴏᴀᴅᴇʀ* 』\n\n *Name* : ${result.name}\n *Size* : ${result.size}\n *Mime* : ${result.mime}\n\n\n${Config.caption}`;
 ...
 cmd({
   ...
   if (_0xb75e78.quoted && _0xb75e78.text) {
     ...
     if (_0x5b8ee5[0].includes("qᴜᴇᴇɴ_ᴍᴀʀɪᴀ • sᴏɴɢ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ")) {
     ...
     } else if (_0x5b8ee5[0].includes("qᴜᴇᴇɴ_ᴍᴀʀɪᴀ • ᴀᴘᴋ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪsᴛ")) {
...
smd({
  ...
  try {
    ...
    try {
      ...
      let _0x452f00 = _0x5c3baf.title || _0x57ada1 || _0x13f167[0x1] || "Queen_Maria -- YT Video";
      if (_0x57ada1) {
