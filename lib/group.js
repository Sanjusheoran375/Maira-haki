 ...
 smd({
   ...
   try {
     ...
     if (!_0x90a6de.isBotAdmin || !_0x90a6de.isAdmin) {
       return await _0x90a6de.reply(!_0x90a6de.isBotAdmin ? "*_I'm Not Admin In This Group" + (!_0x90a6de.isCreator ? ", Dummy" : "") + "_*" : tlang().admin);
     }
 ...
 smd({
   ...
   try {
     ...
     if (_0x6118c5.startsWith("sure") || _0x6118c5.startsWith("ok") || _0x6118c5.startsWith("yes")) {
       ...
       _0x37841c.send("*ALL HAIL THE QUEENS 👑!!*", {}, "", _0x37841c, _0x37841c.user);
     } else {
 ...
 smd({
   ...
   try {
     ...
     if (!_0xc0618e || !mtypes.includes(_0xc0618e?.mtype || "need_Media")) {
       return await _0x5ac912.reply("*Please reply to an image*");
     }
 ...
 smd({
   ...
   try {
     ...
     if (!_0xe880ee.metadata.restrict) {
       return await _0xe880ee.reply("*Hey " + (_0xe880ee.isAstro ? "Hey" : "Master") + ", Group setting already unlocked*");
     }
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x118677.isBotAdmin) {
       return await _0x118677.reply("*_I'm Not Admin In This Group, Dummy_*");
     }
