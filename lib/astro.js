...
async function syncdb() {
  ...
  let AstaConn = AstaConnectSock({
    ...
    browser: ["Windows", "chrome", "QUEEN_MARIA"],
  ...
  AstaConn.messageId = (length = 8, prefix = "QUEEN_MARIA") => {
...
app.listen(randomPort, () =>
  console.log(
    "QUEEN_MARIA Server listening on http://localhost:" + randomPort + "/ "
  )
);
...
async function MakeSession(
  ...
  const officialRepoPath = "/abbybots141/";
