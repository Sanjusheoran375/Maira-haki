...
setMention.check = async (_0x373988, _0x3c756b = "", _0xde3e80 = false) => {
  try {
    const _0x313fc4 = _0xde3e80 || _0x373988.mentionedJid.includes(_0x373988.user) || _0x3c756b.includes("@" + _0x373988.user.split("@")[0]) || global.mentionasta && (_0x373988.mentionedJid.includes("@2347032411938@s.whatsapp.net") || _0x373988.mentionedJid.includes("@263710405675@s.whatsapp.net") || /@2347032411938|@263710405675/g.test(_0x3c756b));
    if (_0x313fc4) {
      if (global.AstroOfficial !== "yes") {
        return;
      }
